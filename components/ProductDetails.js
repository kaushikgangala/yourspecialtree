    ...
    <>
        ...
        <ul className="list-disc list-inside space-y-4 text-gray-700 text-lg">
          <li>
            <span className="font-semibold text-gray-900">
              A Piece of Your Holiday Story:{" "}
            </span>
            This tree skirt will be a part of your family’s Christmas traditions
            for years to come, creating memories every season.
          </li>
          <li>
            <span className="font-semibold text-gray-900">
              Wrapped in Comfort:{" "}
            </span>
            Feel the warmth of soft, plush fleece as you gather with loved ones
            around the tree—cozy, just like home.
          </li>
          <li>
            <span className="font-semibold text-gray-900">
              Made Just for You:{" "}
      ...
      <div className="bg-white text-red-600 max-w-md mx-auto p-6 rounded-lg shadow-lg border border-red-600">
        ...
        <div className="mt-6 text-center">
          <button
            className="bg-red-600 text-white px-6 py-3 rounded-md shadow-lg hover:bg-red-700 transition duration-300 transform hover:scale-105"
